...
public class Sanitary_finished_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Senatory finished");
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Sanetory_Finished_Form_Submit(user_id, Date, Inward_time, Outward_time, Lorry_no, Chalan_no, Party_name, Quantity, Amount, Rate,
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Sanitary_finished_Activity.this, date, myCalendar
        ...
        watch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Sanitary_finished_Activity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void Sanetory_Finished_Form_Submit(String user_id, String date, String inward_time, String outward_time,
        ...
        Call<Bricks_Form_Responce> login_Call = LoginApi.Sanetory_Finished_form_Call_Api(user_id, date, inward_time, outward_time, lorry_no, chalan_no, party_name
        ...
        login_Call.enqueue(new Callback<Bricks_Form_Responce>() {
            ...
            public void onResponse(Call<Bricks_Form_Responce> call, Response<Bricks_Form_Responce> response) {
                ...
                Toast.makeText(Sanitary_finished_Activity.this, "Successful", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Sanitary_finished_Activity.this, Successful_form_Activity.class);
