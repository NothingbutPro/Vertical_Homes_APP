...
public class Cement_Material_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Cement_Material_Activity.this, date, myCalendar
        ...
        watch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Cement_Material_Activity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
