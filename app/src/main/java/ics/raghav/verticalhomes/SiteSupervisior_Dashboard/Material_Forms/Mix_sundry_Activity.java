...
public class Mix_sundry_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Mix_sundry_Activity.this, date, myCalendar
        ...
        watch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Mix_sundry_Activity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
