...
public class Electric_raw_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Electric_raw_Activity.this, date, myCalendar
        ...
        watch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Electric_raw_Activity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
