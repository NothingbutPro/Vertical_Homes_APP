...
public class Electric_finish_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Electric_finish_Activity.this, date, myCalendar
        ...
        watch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Electric_finish_Activity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
